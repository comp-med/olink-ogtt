setwd("/sc-projects/sc-proj-computational-medicine/people/Burulca/06_fasting_ogtt/04_gwas/output")
...
source("../scripts/plot_manhattan.R")
pdf("../graphics/anxa10_manhattan.pdf", width = 10, height = 5)
plot_manhattan(filt_data, c("rs139558368","rs2990223","rs760077","rs4600882","rs6914749"))
dev.off()
